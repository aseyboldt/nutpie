...
function. The callback receives a `numpy.random.Generator` and must return a
...
constrained and unconstrained parameterizations. This makes it possible to build
initial points from model-space values, including constrained parameters:
